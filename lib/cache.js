...
export function getContractCacheStats() {
  const { getContractCacheStats } = require('./contract-cache.js');
...
export function clearContractCache() {
  const { clearContractCache } = require('./contract-cache.js');
...
export function clearContractCacheForToken(tokenId) {
  const { clearContractCacheForToken } = require('./contract-cache.js');
 ...
 */
export function cleanupExpiredContractEntries() {
  const { cleanupExpiredEntries } = require('./contract-cache.js');
...
export function getJsonCacheStats() {
  const { getJsonCacheStats } = require('./json-cache.js');
...
export function clearJsonCache() {
  const { clearJsonCache } = require('./json-cache.js');
...
export function cleanupExpiredJsonEntries() {
  const { cleanupExpiredJsonEntries } = require('./json-cache.js');
