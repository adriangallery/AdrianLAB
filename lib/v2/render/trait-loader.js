...
async function loadFromHTTP(traitId, { subdir, customPath }) {
  ...
  // Resolve once and prepend it to the candidate list so the legacy
  // adrianzero.com/designs/<id>.svg path is only used as a last-resort fallback
  // (it 404s for V2 mints).
