...
const GUMBALL_MINT_ABI = [
  ...
  'function gumballGetAllMintedTokens() view returns (uint256[])',
];
...
export function encodeGumballGetAllMintedTokens() {
  return {
    target: CONTRACTS.ZERO_DIAMOND,
    callData: iGumballMint.encodeFunctionData('gumballGetAllMintedTokens', []),
    iface: iGumballMint,
    fnName: 'gumballGetAllMintedTokens',
  };
}
