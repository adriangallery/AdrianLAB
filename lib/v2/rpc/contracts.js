...
const ZEROMOVIES_ABI = [
  ...
  'function getRentalConfig() view returns (uint256 burnBps, uint256 holderBps, uint256 revenueBps, uint256 depositBps, uint256 keepThreshold, address nftContract, uint256 totalActiveRentals, uint256 totalDepositsHeld, uint256 totalReturns, uint256 totalRewardsDistributed)',
];
...
export function encodeGetRentalConfig() {
  return {
    target: CONTRACTS.ZERO_DIAMOND,
    callData: iZEROmovies.encodeFunctionData('getRentalConfig', []),
    iface: iZEROmovies,
    fnName: 'getRentalConfig',
  };
}
