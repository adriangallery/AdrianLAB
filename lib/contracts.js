...
const CONTRACT_ADDRESSES = {
  ...
  EXTENSIONS: process.env.ADRIAN_LAB_EXTENSIONS_ADDRESS || '0xb6ec8c4dbe7f770388f11f78db687c19db8e7227',
...
async function testCriticalFunctions() {
  try {
    ...
    // Test getTokenData
    await contracts.core.getTokenData(1);
    console.log('[testCriticalFunctions] ✅ getTokenData working');
    
    // Test getAllEquippedTraits
    await contracts.extensions.getAllEquippedTraits(1);
    console.log('[testCriticalFunctions] ✅ getAllEquippedTraits working');
