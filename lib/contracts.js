...
import AdrianLabCoreABI from '../abis/AdrianLabCore.json' assert { type: 'json' };
import AdrianLabExtensionsABI from '../abis/AdrianLabExtensions.json' assert { type: 'json' };
import AdrianTraitsCoreABI from '../abis/AdrianTraitsCore.json' assert { type: 'json' };
...
export async function initializeContracts() {
  ...
  try {
    ...
    console.log('[initializeContracts] ABI Extensions:', JSON.stringify(AdrianLabExtensionsABI, null, 2));
