  ...
  async generateGif(config) {
    ...
    for (let i = 0; i < frameCanvases.length; i++) {
      ...
      try {
        ...
        // BitmapImage acepta: new BitmapImage(width, height, buffer) o new BitmapImage({width, height, data})
        ...
        // Intentar con formato posicional primero (width, height, buffer)
        const bitmap = new BitmapImage(imageData.width, imageData.height, buffer);
