...
export class FloppyRenderer {
  ...
  async #loadExternalTraitForFloppy(traitId) {
    try {
      ...
      // V1 (legacy 30000-30300): URL is the hardcoded adrianzero.com/designs path.
      let imageUrl;
      if (isTShitV2(traitId)) {
        ...
        imageUrl = `${baseUrl}/${traitId}.svg`;
        console.log(`[FloppyRenderer] 🌐 V1 legacy URL: ${traitId} -> ${imageUrl}`);
      }
