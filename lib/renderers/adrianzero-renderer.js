...
export class AdrianZeroRenderer {
  ...
  async generatePNGForLambo(tokenId, options = {}) {
    ...
    // 1. Generar AdrianZERO completo NORMAL (reutilizar el original)
    console.log('[AdrianZeroRenderer] Generando AdrianZERO completo normal para lambo...');
    const adrianBuffer = await this.#generatePNGInternal(tokenId);
