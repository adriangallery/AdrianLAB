      ...
      if (equippedTraits[category]) {
        ...
        if (traitId >= 30000 && traitId <= 35000) {
          ...
          if (traitId >= 500 && traitId <= 1099) {
            ...
            console.log(`[AdrianZeroRenderer] 🥷 Cargando SamuraiZERO trait desde: ${imageUrl}`);
            ...
            try {
              ...
              if (response.ok) {
                ...
                console.error(`[AdrianZeroRenderer] 🥷 Error HTTP al cargar SamuraiZERO trait ${traitId}: ${response.status}`);
              }
            } catch (error) {
